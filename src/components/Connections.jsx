        ...
        {connections.map((conn) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mt-3 line-clamp-3">{conn.about}</p>

              <p className="mt-4 font-semibold text-gray-700">
                💜 Looking for{" "}
                <span className="text-violet-600">{conn.lookingFor}</span>
              </p>

              <p className="text-sm text-gray-400 mt-3">{conn.email}</p>
              ...
              <div className="flex gap-4 mt-6">
                <Link
                  to={"/chat/" + conn._id}
                  className="
                  flex-1 py-2 rounded-xl font-semibold text-white text-center
